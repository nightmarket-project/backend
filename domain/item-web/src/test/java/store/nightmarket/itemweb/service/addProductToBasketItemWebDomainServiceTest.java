...
import static store.nightmarket.itemweb.fixture.TestItemFactory.ProductItemTestData;
import static store.nightmarket.itemweb.fixture.TestItemFactory.createTestData;
...
class addProductToBasketItemWebDomainServiceTest {
    ...
    void shouldAddProductToBasketWhenProductIsSufficient() {
        ...
        Input input = Input.builder()
                ...
                .userBuyProductItem(testData.getUserProductItem())
                .shoppingBasket(shoppingBasket)
                .build();
        ...
        softly.assertThat(userBuyProductItems).hasSize(1);
        softly.assertThat(userBuyProductItems.getFirst().getItemId()).isEqualTo(
                testData.getUserProductItem().getItemId());
        softly.assertAll();
    }
