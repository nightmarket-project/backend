...
class CancelManyPurchaseProductItemDomainServiceDtoTest {

    private CancelManyPurchaseProductItemDomainServiceDto service;
    private SoftAssertions softly;

    @BeforeEach
    void setUp() {
        service = new CancelManyPurchaseProductItemDomainServiceDto();
        softly = new SoftAssertions();
    }

    @Test
    @DisplayName("서비스 실행시 장바구니 상품 구매 취소가 성공하고 재고가 복구된다.")
