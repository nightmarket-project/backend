...
import store.nightmarket.domain.item.service.dto.PutProductIntoShoppingBasketDomainServiceDto.Event;
import store.nightmarket.domain.item.service.dto.PutProductIntoShoppingBasketDomainServiceDto.Input;
import store.nightmarket.domain.item.valueobject.Quantity;

class PutProductIntoShoppingBasketDomainServiceTest {

	private PutProductIntoShoppingBasketDomainService service;
	private SoftAssertions softly;

	@BeforeEach
	void setUp() {
		service = new PutProductIntoShoppingBasketDomainService();
	...
	void shouldUpdateProductQuantityInCartWhenServiceIsExecuted() {
		...
		ShoppingBasketProduct shoppingBasketProduct = TestFactory.createShoppingBasketProduct(
			UUID.randomUUID(),
			UUID.randomUUID(),
			userId,
			"CPU",
