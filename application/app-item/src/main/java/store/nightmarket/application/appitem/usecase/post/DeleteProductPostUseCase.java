...
import static store.nightmarket.application.appitem.usecase.post.dto.DeleteProductPostUseCaseDto.*;
...
public class DeleteProductPostUseCase implements BaseUseCase<Input, Void> {
