...
import static store.nightmarket.application.appitem.usecase.post.dto.UnpublishProductPostUseCaseDto.*;
...
public class UnpublishProductPostUseCase implements BaseUseCase<Input, Void> {
