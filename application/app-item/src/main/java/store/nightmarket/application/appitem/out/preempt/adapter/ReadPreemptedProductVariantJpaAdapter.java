package store.nightmarket.application.appitem.out.preempt.adapter;
...
import store.nightmarket.application.appitem.out.preempt.mapper.PreemptedProductVariantMapper;
